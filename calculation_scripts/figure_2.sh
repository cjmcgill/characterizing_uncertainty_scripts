...
--dataset_type regression \
--split_sizes 0.8 0.2 0 \
--data_path $dataset_dir/dataset/noise${noise}_unifom/groupadditivity_${fraction}_noise${noise}_uni.csv \
--save_dir $results_dir/noise${noise}_uni/${fraction}/${seed} \
--seed 0 \
--pytorch_seed ${seed} \
--aggregation norm \
--depth 4 \
...
python $chemprop_dir/predict.py \
--test_path $dataset_dir/dataset/groupadditivity_test.csv \
--checkpoint_dir $results_dir/noise${noise}_uni/${fraction}/${seed} \
--preds_path $results_dir/noise${noise}_uni/${fraction}/${seed}/test_preds.csv \
# --gpu 0 

python $chemprop_dir/predict.py \
--test_path $dataset_dir/dataset/groupadditivity_test.csv \
--checkpoint_dir $results_dir/noise${noise}_uni/${fraction} \
--preds_path $results_dir/noise${noise}_uni/${fraction}/test_preds.csv \
# --gpu 0 
...
--dataset_type regression \
--split_sizes 0.8 0.2 0 \
--data_path $dataset_dir/dataset/noise${noise}_unifom/groupadditivity_${fraction}_noise${noise}_bimod.csv \
--save_dir $results_dir/noise${noise}_bimod/${fraction}/${seed} \
--seed 0 \
--pytorch_seed ${seed} \
--aggregation norm \
--depth 4 \
...
python $chemprop_dir/predict.py \
--test_path $dataset_dir/dataset/groupadditivity_test.csv \
--checkpoint_dir $results_dir/noise${noise}_bimod/${fraction}/${seed} \
--preds_path $results_dir/noise${noise}_bimod/${fraction}/${seed}/test_preds.csv \
# --gpu 0 

python $chemprop_dir/predict.py \
--test_path $dataset_dir/dataset/groupadditivity_test.csv \
--checkpoint_dir $results_dir/noise${noise}_bimod/${fraction} \
--preds_path $results_dir/noise${noise}_bimod/${fraction}/test_preds.csv \
# --gpu 0 
...
--dataset_type regression \
--split_sizes 0.8 0.2 0 \
--data_path $dataset_dir/dataset/noise${noise}_cosh/groupadditivity_${fraction}_noise${noise}_cosh.csv \
--save_dir $results_dir/noise${noise}_cosh/${fraction}/${seed} \
--seed 0 \
--pytorch_seed ${seed} \
--aggregation norm \
--depth 4 \
...
python $chemprop_dir/predict.py \
--test_path $dataset_dir/dataset/groupadditivity_test.csv \
--checkpoint_dir $results_dir/noise${noise}_cosh/${fraction}/${seed} \
--preds_path $results_dir/noise${noise}_cosh/${fraction}/${seed}/test_preds.csv \
# --gpu 0 

python $chemprop_dir/predict.py \
--test_path $dataset_dir/dataset/groupadditivity_test.csv \
--checkpoint_dir $results_dir/noise${noise}_cosh/${fraction} \
--preds_path $results_dir/noise${noise}_cosh/${fraction}/test_preds.csv \
# --gpu 0 
