...
--data_path $dataset_dir/dataset/noise20_${noise}/groupadditivity_${fraction}_noise20_${noise}.csv \
...
python predict.py \
--test_path $dataset_dir/dataset/noise20_${noise}/groupadditivity_test_noise20_${noise}.csv \
